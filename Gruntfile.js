...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    jasmine: {
      options: {
        helpers: ["<%= assets.sinon %>", "<%= assets.jasmineSinon %>", "spec/javascripts/helpers/*.js"],
        specs: "spec/javascripts/**/*.spec.js",
        vendor: ["<%= assets.jquery %>", "<%= assets.underscore %>", "<%= assets.backbone %>", "<%= assets.babysitter %>", "<%= assets.wreqr %>"],
        keepRunner: true
      },
      marionette: {
        src: ["<%= preprocess.bundle.dest %>", "spec/javascripts/support/marionette.support.js"]
      }
    },
    plato: {
      marionette: {
